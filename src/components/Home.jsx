        ...
        const fetchData = async () => {
            ...
            if (email) {
                try {
                    ...
                    const configuration = {
                        method: "post",
                        url: "https://express-rho-livid.vercel.app/api/v1/getUser",
                        data: {email: email},
                    };
                    ...
                    if(response.data.data.is_verified_email){
                        const configuration2 = {
                            method: "post",
                            url: "https://express-rho-livid.vercel.app/api/v1/getHome",
                            data: {email: email},
                        };
    ...
    const handleResendVerification = async () => {
        ...
        if (email) {
            try {
                ...
                const configuration = {
                    method: "post",
                    url: "https://express-rho-livid.vercel.app/api/v1/resend_verify_email",
                    data: {email: email},
                };
                const response = await axios(configuration);
